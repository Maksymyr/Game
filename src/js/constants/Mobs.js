...
export const mobs= [
    ...
    ,[
        {name: "Goblin", type: "Humanoid", drop: items.glovewar,  exp: 3, img: goblin, curHP: 60, maxHP: 60, curMP: 10, maxMP: 10, lvl: 1, str: 4, dex: 5, con: 6, int: 1, wit: 1 }, 
        {name: "Cock", type: "Bird", drop: items.glovemag, exp: 3, img: han, curHP: 40, maxHP: 40, curMP: 10, maxMP: 10, lvl: 1, str: 3, dex: 6, con: 4, int: 1, wit: 1 }, 
    ...
    ,[
        {name: "Ent", type: "Humanoid", drop: items.manapot, exp: 7, img: ent, curHP: 70, maxHP: 70, curMP: 20, maxMP: 20, lvl: 2, str: 8, dex: 6, con: 7, int: 2, wit: 2 }, 
        {name: "Horse", type: "Animal", drop: items.lowwand, exp: 7, img: horse, curHP: 60, maxHP: 60, curMP: 20, maxMP: 20, lvl: 2, str: 6, dex: 6, con: 6, int: 2, wit: 2 }, 
        {name: "Lion", type: "Animal", drop: items.lowbow, exp: 8, img: lion, curHP: 80, maxHP: 80, curMP: 20, maxMP: 20, lvl: 2, str: 7, dex: 9, con: 8, int: 2, wit: 2 },         
        {name: "Bearbird", type: "Animal", drop: items.lowsword, exp: 10, img: bearbird, curHP: 100, maxHP: 100, curMP: 20, maxMP: 20, lvl: 2, str: 12, dex: 4, con: 10, int: 2, wit: 2 }]    
    ,[
        {name: "Werewolf", type: "Humanoid", drop: items.bootsarc, exp: 21, img: werewolf, curHP: 120, maxHP: 120, curMP: 30, maxMP: 30, lvl: 3, str: 10, dex: 7, con: 12, int: 3, wit: 3 }, 
        {name: "Beast", type: "Animal", drop: items.bootswar, exp: 27, img: beast, curHP: 160, maxHP: 160, curMP: 30, maxMP: 30, lvl: 3, str: 12, dex: 6, con: 16, int: 3, wit: 3 }, 
        {name: "Forest golem", type: "Creature", drop: items.skill, exp: 40, img: forest_golem, curHP: 200, maxHP: 200, curMP: 30, maxMP: 30, lvl: 3, str: 9, dex: 5, con: 20, int: 3, wit: 3 },         
        {name: "Unicorn", type: "Animal", drop: items.bootsmag, exp: 23, img: unicorn, curHP: 130, maxHP: 130, curMP: 30, maxMP: 30, lvl: 3, str: 11, dex: 6, con: 13, int: 3, wit: 3 }]   
    ,[
    ...
    ,[
        ...
        {name: "Demon warrior", type: "Demon", drop: items.pantwar, exp: 95, img: demonwar, curHP: 320, maxHP: 320, curMP: 50, maxMP: 50, lvl: 5, str: 20, dex: 8, con: 32, int: 5, wit: 5 }]
